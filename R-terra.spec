...
Version  : 1.5.21
Release  : 19
URL      : https://cran.r-project.org/src/contrib/terra_1.5-21.tar.gz
Source0  : https://cran.r-project.org/src/contrib/terra_1.5-21.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647041130
